...
if($_POST){
    ...
    if(empty($nama_siswa)){
        ...
        include "koneksi.php";
        $insert=mysqli_query($conn,"insert into siswa (nama_siswa,tanggal_lahir, alamat, gender, username, password, ID_kelas, id_jurusan)
        value ('".$nama_siswa."','".$tanggal_lahir."','".$alamat."','".$gender."','".$username."','".md5($password)."','".$ID_kelas."','".$id_jurusan."')") or die(mysqli_error($conn));
        if($insert){
